...
// type IGibletActionState interface {
// 	EnterState()
// 	GoMoving(obj *GibletObject)
// 	DoMoving(obj *GibletObject)
// 	GoIdle(obj *GibletObject)
// 	DoIdle(obj *GibletObject)
// }
...
// func (gibletObj *GibletObject) ChangeControlState(newState IControlState) {

// }

// func (gibletObj *GibletObject) ChangeState(newState IGibletActionState) {
